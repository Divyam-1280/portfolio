  ...
  return (
    <motion.div
      ...
      <div className="h-full flex flex-col gap-6 overflow-auto scrollbar-hide">
        ...
        <div className="w-full flex mt-10 text-white justify-center md:text-4xl text-3xl font-semibold sm:px-8 md:px-12 lg:px-20 xl:px-48">
          <h1>Projects</h1>
        </div>
        <div className="w-full h-full pb-28 mt-10 flex flex-wrap gap-11 justify-center md:text-3xl text-2xl font-semibold sm:px-8 md:px-12 lg:px-20 xl:px-32">
          ...
          <a href="https://movierater.vercel.app/">
            <PinContainer
              title="Visit the Website"
              href="https://movierater.vercel.app/">
              <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem] ">
                <h3 className="max-w-xs !pb-2 !m-0 font-bold  text-base text-black">
                  Movie App
                </h3>
                <div className="text-base !m-0 !p-0 font-normal">
                  <span className="text-black ">
                    A website which fetches data of movies and shows from API
                    and displays it
                  </span>
                </div>
                <div className="flex flex-1 w-full rounded-lg mt-4 movie-image" />
              </div>
            </PinContainer>
          </a>
          <a href="https://hariyali.vercel.app/">
            <PinContainer
              title="Visit the Website"
              href="https://hariyali.vercel.app/">
              <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem] ">
                <h3 className="max-w-xs !pb-2 !m-0 font-bold  text-base text-black">
                  Hariyali Restaurant
                </h3>
                ...
                <div className="flex flex-1 w-full rounded-lg mt-4 hariyali-image" />
              </div>
            </PinContainer>
          </a>
        </div>
